...
public class Adapter_buy_mFood extends RecyclerView.Adapter<Adapter_buy_mFood.ViewHolder> {
    private List<Data_buy> foodList;
    private Context context;

    public Adapter_buy_mFood(List<Data_buy> foodList, Context context) {
